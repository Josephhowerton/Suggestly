...
@Entity
public class FoursquareVenue extends Suggestion {
    @PrimaryKey
    @NonNull
    public String id;
    public String name;
    @Embedded public FoursquareContact contact;
    @Embedded public FoursquareLocation location;
    ...
    public FoursquareVenue(@NonNull String id) {
        this.id = id;
    }
    ...
    public void addVenueDetails(FoursquareVenue venue){
