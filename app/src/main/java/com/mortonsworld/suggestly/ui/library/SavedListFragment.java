...
import com.mortonsworld.suggestly.databinding.FragmentSavedListBinding;
...
public class SavedListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        FragmentSavedListBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_saved_list, container, false);
