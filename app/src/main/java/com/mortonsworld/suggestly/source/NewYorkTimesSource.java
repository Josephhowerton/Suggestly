...
import com.mortonsworld.suggestly.model.nyt.Result;
import com.mortonsworld.suggestly.retrofit.NewYorkTimesManager;
import com.mortonsworld.suggestly.retrofit.NewYorkTimesService;
import com.mortonsworld.suggestly.retrofit.ServiceFactory;
import com.mortonsworld.suggestly.room.NewYorkTimesDAO;
...
public class NewYorkTimesSource {
    ...
    public DataSource.Factory<Integer, Book> readNewYorkTimesBookListDataFactory(String listName){
        try {
            return executorService.submit(() -> newYorkTimesDAO.readBooksByListNameDataFactory(listName)).get();
